...
<main class="xs-main">
    ...
    <section class="xs-section-padding bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="xs-donation-form-images"><img src="{data.thumbnail}" class="img-responsive"
                    ...
                    <div class="xs-donation-form-wraper">
                        ...
                        <form action="#" method="post" id="xs-donation-form" class="xs-donation-form"
                            ...
                            <div class="xs-input-group">
                                ...
                                <input type="text" name="name"id="xs-donate-name" class="form-control" placeholder="Minimum of $5"> </div>
                            <div class="xs-input-group">
                            ...
                            <div class="xs-input-group">
                                ...
                                <input type="mail" name="name" id="xs-donate-name" class="form-control" placeholder="email@awesome.com">
                            </div>
                            ...
                            <!-- .xs-input-group END -->
                            <button type="submit" class="btn btn-warning"><span class="badge"><i
