                    ...
                    <div class="xs-donation-form-wraper">
                        ...
                        <form on:submit|preventDefault={handleForm} action="#" method="post" id="xs-donation-form" class="xs-donation-form"
                            ...
                            <div class="xs-input-group">
                                ...
                                <input type="text" name="amount" required id="xs-donate-name" class="form-control" bind:value="{amount}" placeholder="Your donation in Rupiah"> </div>
                            <div class="xs-input-group">
                                <label for="xs-donate-name">Your Name<span class="color-light-red">**</span></label>
                                <input type="text" name="name" required id="xs-donate-name" class="form-control" bind:value="{name}" placeholder="Your awesome name">
                            </div>
                            <div class="xs-input-group">
                                <label for="xs-donate-name">Your Email<span class="color-light-red">**</span></label>
                                <input type="mail" name="email" required id="xs-donate-name" class="form-control" bind:value="{email}" placeholder="email@awesome.com">
                            </div>
